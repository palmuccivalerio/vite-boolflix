...
Esempio chiamata:
https://api.themoviedb.org/3/search/movie?api_key=e99307154c6dfb0b4750f6603256716d&query=ritorno+al+fut uro
...
aggiuntive già prese nei punti precedenti più la overview
 ...
 axios
      ...
      .then((resp) => {
        // Qui il codice viene eseguito solo se la risposta è corretta
        console.log(resp);
      })
      .catch((error) => {
        // se arriva la risposta con un errore, allora verrà eseguito questo codice
        console.log(error);
      })
      .finally(() => {
